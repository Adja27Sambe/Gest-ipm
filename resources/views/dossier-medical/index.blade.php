...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Historique demandes - Recherche de bénéficiaire</h2>
    </div>
                ...
                <tbody>
                    @foreach($salaries as $salarie)
                        ...
                        <tr class="clickable-row" data-href="{{ route('dossier-medical.show', ['type' => 'salarie', 'id' => $salarie->id_salarie]) }}">
                            ...
                            <td><span class="badge bg-primary">Participant</span></td>
                            ...
                            <td class="text-end">
                                <a href="{{ route('dossier-medical.show', ['type' => 'salarie', 'id' => $salarie->id_salarie]) }}" class="btn btn-sm btn-info text-white">
                                    <i class="fas fa-folder-open"></i> Voir l'historique
                                </a>
                            </td>
                        </tr>
                        <!-- Ayants Droit du Participant -->
