                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="py-3 px-4 text-uppercase text-secondary fw-semibold" style="font-size: 0.85rem;">Entreprise</th>
                                    ...
                                    <td class="px-4 py-3 text-end">
                                        @if($cotisation->statut == 'impayee')
                                            <form action="{{ route('cotisations.payer', $cotisation->id_cotisation) }}" method="POST" class="d-inline" onsubmit="return confirm('Confirmer le paiement ?');">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success rounded-circle me-1" title="Marquer comme payée">
                                                    <i class="bi bi-cash-stack"></i>
                                                </button>
                                            </form>
                                        @endif
                                        <a href="{{ route('cotisations.edit', $cotisation->id_cotisation) }}" class="btn btn-sm btn-outline-primary rounded-circle me-1" title="Modifier">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                <th class="py-3 px-4 text-uppercase text-secondary fw-semibold" style="font-size: 0.85rem;">Période</th>
                                <th class="py-3 px-4 text-uppercase text-secondary fw-semibold" style="font-size: 0.85rem;">Salarié</th>
